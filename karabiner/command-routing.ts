...
const bindings: CommandBinding[] = [
  ...
  {
    "command": "open -g rectangle://execute-action?name=right-half",
    "key": "f13",
    "modifiers": [
      "left_command",
      "left_option"
  ...
  {
    "command": "open -g rectangle://execute-action?name=top-half",
    "key": "f14",
    "modifiers": [
      "left_command",
      "left_option"
